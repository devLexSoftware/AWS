        ...
        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="production/core/clientes/actions/updateClientes.php">
            <div class="form-group row">
                ...
                <div class="col-md-3">
                    ...
                    <input type="text"  maxlength="13" minlength="13" name="cli_rfc" id="cli_rfc" class="form-control col-md-7 col-xs-12" placeholder="Ingrse el RFC del cliente" value="<?php echo($elemento['rfc']); ?>">                                                      
                </div>
                <div class="col-md-3">
