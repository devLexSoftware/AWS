        ...
        <div class="animate form login_form">
          <section class="login_content">
            <form method="post" action="production/core/login/actions/validate.php">
              <h1>Bienvenido</h1>
              <div>
                <input id="Username_Login" name="Username_Login" type="text" class="form-control" placeholder="Usuario" required="" />
              </div>
              <div>
              ...
              <div class="separator">
                ...
                <div>
                  <p>Lex Software SA de CV © 2018 All Rights Reserved. Privacy and Terms</p>
                </div>
              </div>
            </form>
          </section>
