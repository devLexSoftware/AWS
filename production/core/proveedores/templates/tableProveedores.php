...
echo "Fallo al conectar a MySQL: (" . $mysqli->connect_errno . ") " . $mysqli->connect_error;
    ...
    $result = mysqli_query($con,"SELECT * FROM proveedores WHERE estado = 0 ");    
}
?>
        ...
        while($elemento = mysqli_fetch_array($result)){
            ...
            <tr>
                ...
                <td><button type="button" id="mostrar" name="boton1"  class="btn btn-primary btn-sm">
                        <a style="text-decoration: none; text-align:center; color: white; " href="index.php?p=optionProveedores&ref='.$elemento[identificador].'"> Editar</a>
                    </button>
                </td>     
            </tr>
            ';
