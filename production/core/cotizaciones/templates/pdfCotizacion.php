...
<page style="font-size: 14px">
    ...
    <table border=0.5   bordercolor="#73879ca3" width=1440 >            
        <tr>            
            <td style="text-align: center; padding: 5px 2px; color: white; width:632px;" ></td>
            <td style="text-align: center; padding: 5px 2px;color:black; background-color: #a4bcda; width:120px;">Construcción M2</td>
            <td style="text-align: center; padding: 5px 2px; width:120px;"><?php echo $elemento[superficie] ?></td>
            <td style="text-align: center; padding: 5px 2px; width:120px;">$<?php echo $totDirecto ?></td>
            <td style="text-align: center; padding: 5px 2px; width:120px;">$<?php echo $totcReal ?></td>
            <td style="text-align: center; padding: 5px 2px; width:120px;">$<?php echo $totResta ?></td>
            <td style="text-align: center; padding: 5px 2px; width:120px;"></td>
    ...
    <table bordercolor="#007"  style="font-size: 11px; width:100%; " >           
            <tr style="background-color: #1E8EC6; color:#333333; text-align: center;">
                <th style=" padding: 10px 2px; width: 10px; "> </th>
                <th style="width: 532px; ">Concepto </th>
                <th style="width: 100px;">Unidad </th>
                <th style="width: 50px;">Cant</th>
                <th style="width: 70px;">Costo</th>
                <th style="width: 70px;">Util</th>
                <th style="width: 70px;">Admin</th>
                <th style="width: 70px;">Directo</th>
                <th style="width: 70px;">C.U.</th>
                <th style="width: 70px;">Descuento</th>
                <th style="width: 70px;">Costo Real</th>
                <th style="width: 70px;">Ganancia Real</th>
            ...
            <tr style="color:black;">
                ...
                foreach ($el1 as $elemento1) {                
                        ...
                        <tr'; if($bandera == false){ echo ' style=" background-color: #CFE1F5;"'; } echo '>
                            ...
                            <td style=" padding: 5px 2px; border-bottom: 1px solid #B4B5B0; ">'.wordwrap($elemento1[concepto],100,"<br>\n",TRUE).'</td>                            
                            <td style="border-bottom: 1px solid #B4B5B0; ">'.$elemento1[unidad].'</td>            
                            <td style="border-bottom: 1px solid #B4B5B0; ">'.$elemento1[cantidad].'</td> 
                            <td style="border-bottom: 1px solid #B4B5B0; ">$'.$elemento1[costo].'</td>            
                            <td style="border-bottom: 1px solid #B4B5B0; ">$'.$elemento1[util].'</td>            
                            <td style="border-bottom: 1px solid #B4B5B0; ">$'.$elemento1[admin].'</td>                                        
                            <td style="border-bottom: 1px solid #B4B5B0; ">$'.$elemento1[directo].'</td>                                        
                            <td style="border-bottom: 1px solid #B4B5B0; ">$'.$elemento1[cu].'</td>                                        
                            <td style="border-bottom: 1px solid #B4B5B0; ">$'.$elemento1[descuento].'</td>                                        
                            <td style="border-bottom: 1px solid #B4B5B0; ">$'.$elemento1[costo_real].'</td>                                        
                            <td style="border-bottom: 1px solid #B4B5B0; ">$'.$elemento1[ganancia_real].'</td>                                        
                            <td style="border-bottom: 1px solid #B4B5B0; ">$'.$elemento1[real_valor].'</td>                                        
