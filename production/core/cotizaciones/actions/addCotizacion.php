...
$con = mysqli_connect(DB_SERVER, DB_USER, DB_PASS, DB_NAME);
  if (mysqli_connect_errno()) {
    ...
    for ($i=0 ; $i <  $cot_cantidad; $i++ ) {
      ...
      $result = mysqli_query($con,"INSERT INTO cotizaciones_detalles(usuCreacion, fk_cotizaciones, proceso, descripcion, duracion, x, unidad, anchoPieza, largo, alto, cantidad, costo, importe, subtotalxtarea, subtotalxfecha, subtotalxproceso, detalles)
